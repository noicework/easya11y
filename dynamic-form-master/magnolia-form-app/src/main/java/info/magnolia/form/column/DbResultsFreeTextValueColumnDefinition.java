 ...
 */
public class DbResultsFreeTextValueColumnDefinition extends IconAndValueColumnDefinition {

    public DbResultsFreeTextValueColumnDefinition() {
        this.setValueProvider(DbResultsFreeTextValueColumnDefinition.ValueProvider.class);
    }
    ...
    public class ValueProvider implements com.vaadin.data.ValueProvider<BaseModel, String> {
        ...
        public String apply(BaseModel item) {
            ...
            if (item instanceof ResponseItem) {
                ...
                value = responseItem.getFreeTextValue();
