...
/**
 * Is not root available rule.
 */
public class IsNotRootActionRule extends AbstractAvailabilityRule {

    public IsNotRootActionRule(AvailabilityDefinition availabilityDefinition, AvailabilityRuleDefinition ruleDefinition) {
