 ...
 */
public class DbFormsDetailsColumnDefinition extends IconAndValueColumnDefinition {
    public DbFormsDetailsColumnDefinition() {
        this.setValueProvider(DbFormsDetailsColumnDefinition.ValueProvider.class);
    }
    ...
    public static class ValueProvider implements com.vaadin.data.ValueProvider<BaseModel, String> {
        ...
        public String apply(BaseModel item) {
            ...
            if (item instanceof Form) {
               value = ((Form) item).getDescription();
            } else if (item instanceof Section) {
                value = ((Section) item).getDescription();
            } else if (item instanceof Question) {
                value = ((Question) item).getQuestion();
            } if (item instanceof AnswerOption) {
                value = ((AnswerOption) item).getLabel();
            }
