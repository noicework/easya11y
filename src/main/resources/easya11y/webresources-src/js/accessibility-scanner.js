...
export const utils = {
    ...
    // This should match the TypeScript implementation in utils.ts
    calculateScore: (scanResult) => {
        ...
        // Calculate weighted violations (matching TypeScript implementation)
        ...
        // Calculate score (matching TypeScript formula)
